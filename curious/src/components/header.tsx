    ...
    headerContent = (
      <>
        <div className='bg-lightGrey dark:bg-darkerGrey rounded-full p-2 flex flex-row items-center gap-5 relative'>
          <Link href="/search" className='text-center w-16 relative z-10' title='Search'>
            Search
          </Link>
          <Link href="/feed" className='text-center w-16 relative z-10' title='Feed'>
            Feed
          </Link>
        ...
        <Link href="/profile" className='h-10 w-10 border-2 border-black dark:border-darkGrey rounded-full overflow-hidden cursor-pointer' title='Profile'>
