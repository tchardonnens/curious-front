...
const Input: React.FC<InputProps> = ({
    ...
    return (
        <div className="relative">
            <input onChange={onChange} type={type} value={value} id={id} className="block rounded-md px-6 pt-6 pb-1 w-full text-md text-black bg-lightGrey appearance-none focus:outline-none focus:ring-0 peer" placeholder=" " />
